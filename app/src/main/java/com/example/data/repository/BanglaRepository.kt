...
class BanglaRepository(private val dao: BanglaDao) {
    ...
    suspend fun initializeDatabaseIfEmpty() = withContext(Dispatchers.IO) {
        ...
        if (currentProgress == null) {
            ...
            val expectedCount = InitialData.getInitialLessons().size
    ...
    suspend fun deleteAllLessons() = withContext(Dispatchers.IO) {
        dao.deleteAllLessons()
    }

    suspend fun deleteLessonById(id: Int) = withContext(Dispatchers.IO) {
