...
object InitialData {
    ...
    fun getInitialLessons(): List<LessonEntity> {
        ...
        list.addAll(TenGrammarLessonsData.getTenLessons())
        list.addAll(DhvonitottoLessons61To80.getLessons61To80())
        list.addAll(DhvonitottoLessons81To92.getLessons81To92())
        list.addAll(DhvonitottoLessons93To100.getLessons93To100())
        list.addAll(BananLessons101To118.getLessons101To118())
        list.addAll(BananLessons119To130.getLessons119To130())
        list.addAll(BananLessons131To140.getLessons131To140())
        list.addAll(BananLessons141To150.getLessons141To150())
        list.addAll(BananLessons151To160.getLessons151To160())
        list.addAll(BananLessons161To170.getLessons161To170())
        list.addAll(BananLessons171To179.getLessons171To179())
        list.addAll(PodTottoLessons180To193.getLessons180To193())
        return list
    }
